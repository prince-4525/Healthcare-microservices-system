...
public class LocalStack extends Stack{
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService", "auth-service",
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET","Tzc1V0hiUExBMWZTNE9Wc1IxUkNMSWlSam5lbjhTaFU="));
    ...
    private Vpc createVpc() {
        return Vpc.Builder
                .create(this, "PatientManagementVPC").vpcName("PatientManagementVPC")
                .maxAzs(2)
                .build();
    }
    ...
    private CfnCluster createMskCluster() {
        return CfnCluster.Builder.create(this, "MskCluster")
                ...
                .brokerNodeGroupInfo(CfnCluster.BrokerNodeGroupInfoProperty.builder()
                        ...
                        .clientSubnets(vpc.getPrivateSubnets().stream().limit(4).map(ISubnet::getSubnetId)
    ...
    public static void main(final String[] args) {
        ...
        StackProps props = StackProps.builder()
                .synthesizer(new BootstraplessSynthesizer()) // here synthesizer will convert our java code to Cloud_Formation_Template
                .build();
